      ...
      <nav ref={navRef}  className="max-w-7xl mx-auto h-20 bg-[#0B0F11]/20 flex justify-between items-center gap-2 text-white py-2 px-5 md:px-10 rounded-full border-2 border-gray-700 backdrop-blur-md">
        ...
        <div>
          ...
          <ul ref={desktopMenuRef} className="md:flex justify-between items-center gap-8 text-lg hidden">
            <li><a href="/" className="text-gray-400 hover:text-white transition-all duration-200">Home</a></li>
            <li><a href="/" className="text-gray-400 hover:text-white transition-all duration-200">About</a></li>
            <li><a href="/" className="text-gray-400 hover:text-white transition-all duration-200">Contact  </a></li>
            <li><a href="/" className="text-gray-400 hover:text-white transition-all duration-200">Projects</a></li>
          </ul>
        </div>
        <div>
          {/* BUTTON */}
